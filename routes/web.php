...
Route::get('/login', function () {
    return redirect(url('/retailer/login'));
})->name('login');
...
Route::get('/{guard}', function ($guard) {
    if ($guard == 'admin')
        ...
        return redirect(url('/' . $guard . '/dashboard'));
})->whereIn('guard', ['admin', 'main_distributor', 'distributor', 'retailer', 'employee']);
...
Route::middleware(['auth:retailer', 'authCheck'])->group(function () {
    Route::name('retailer.')->prefix('retailer')->group(function () {
        ...
        Route::post('electricity-payment-submit', [ElectricityController::class, 'paymentSubmit'])->name('electricity-payment-submit');
        Route::get('electricity-bill-list', [ElectricityController::class, 'list'])->name('electricity-bill-list');
        Route::get('electricity-bill-export', [ElectricityController::class, 'export'])->name('electricity-bill-export');
        ...
        Route::post('water-bill-details', [WaterController::class, 'getDetails'])->name('water-bill-details');
        Route::post('water-payment-submit', [WaterController::class, 'paymentSubmit'])->name('water-payment-submit');
        Route::get('water-bill-list', [WaterController::class, 'list'])->name('water-bill-list');
        Route::get('water-bill-export', [WaterController::class, 'export'])->name('water-bill-export');
        ...
        Route::post('lic-bill-details', [LicController::class, 'getDetails'])->name('lic-bill-details');
        Route::post('lic-payment-submit', [LicController::class, 'paymentSubmit'])->name('lic-payment-submit');
        Route::get('lic-bill-list', [LicController::class, 'list'])->name('lic-bill-list');
        Route::get('lic-bill-export', [LicController::class, 'export'])->name('lic-bill-export');
        ...
        Route::post('gas-bill-details', [GasController::class, 'getDetails'])->name('gas-bill-details');
        Route::post('gas-payment-submit', [GasController::class, 'paymentSubmit'])->name('gas-payment-submit');
        Route::get('gas-bill-list', [GasController::class, 'list'])->name('gas-bill-list');
        Route::get('gas-bill-export', [GasController::class, 'export'])->name('gas-bill-export');
