                ...
                <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                        <div class="nav nav-pills nav-pills-falcon">
                            <a class="btn btn-outline-secondary me-4 add" href="{{ route('roles') }}"> <i
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="switch form-switch-custom switch-inline form-switch-primary">
                                            <input data-type="allow_all" data-module-id="{{ $permission['module_id'] }}"
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                            <input data-type="can_view" data-module-id="{{ $permission['module_id'] }}"
                                                class="switch-input" type="checkbox" role="switch" {{
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="switch form-switch-custom switch-inline form-switch-success">
                                            <input data-type="can_add" data-module-id="{{ $permission['module_id'] }}"
                                                class="switch-input" type="checkbox" role="switch" {{
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="switch form-switch-custom switch-inline form-switch-warning">
                                            <input data-type="can_edit" data-module-id="{{ $permission['module_id'] }}"
                                                class="switch-input" type="checkbox" role="switch" {{
                                    ...
                                    <div class="form-group">
                                        <div class="switch form-switch-custom switch-inline form-switch-danger">
                                            <input data-type="can_delete"
                                                ...
                                                type="checkbox" role="switch" {{ $permission['can_delete']==1
                                                ? 'checked' : '' }} />
                                        </div>
                                    </div>
                                </td>
