...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">Distributors :: Distributor Edit </h5>
            </div>
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <a href="{{ route('distributors')  }}" class="btn btn-outline-secondary me-4"> <i
    ...
    <div class="card-body">
        <form class="row" id="ediUser" method="POST" action="{{ route('distributors.edit', $distributor['id']) }}"
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <select name="main_distributor_id" class="form-select" id="main_distributor_id">
                    ...
                    <option value="{{ $main_distributor['id'] }}" {{ old('main_distributor_id',
                        $distributor['main_distributor_id'])==$main_distributor['id'] ? 'selected' : '' }}>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="mobile" placeholder="Enter Mobile Number" name="mobile" type="text"
                    value="{{ old('mobile', $distributor['mobile']) }}" />
                @error('mobile')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <select name="status" class="form-select" id="status">
                    <option value="1" {{ (old('status', $distributor['status'])==1) ? 'selected' : '' }}> Active
                    </option>
                    <option value="0" {{ (old('status', $distributor['status'])==0) ? 'selected' : '' }}> Inactive
                    </option>
                </select>
                @error('status')
                <span class="invalid-feedback" role="alert">
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <div class="input-group">
                    ...
                    <a href="{{ asset('/storage/'.$distributor['image']) }}" target="_blank" class="btn btn-dark" type="button"><i class="fa-solid fa-download"></i></a>
                    @endif
                </div>
                @error('image')
                <span class="invalid-feedback" role="alert">
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="date_of_birth" type="date" name="date_of_birth" value="{{ old('date_of_birth', $distributor['date_of_birth']) }}" />
                @error('date_of_birth')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <select name="gender" class="form-select" id="gender">
                    ...
                    <option value="male" {{ old('gender', $distributor['gender'])=='male' ? 'selected' : '' }}>Male</option>
                    <option value="female" {{ old('gender', $distributor['gender'])=='female' ? 'selected' : '' }}>Female</option>
                    <option value="other" {{ old('gender', $distributor['gender'])=='other' ? 'selected' : '' }}>Other</option>
                </select>
                @error('gender')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="address" name="address" value="{{ old('address', $distributor['address']) }}" placeholder="Address" />
                @error('address')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="shop_name" placeholder="Enter Shop Name" name="shop_name" type="text" value="{{ old('shop_name', $distributor['shop_name']) }}" />
                @error('shop_name')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="shop_address" name="shop_address" value="{{ old('shop_address', $distributor['shop_address']) }}" placeholder="Shop Address" />
                @error('shop_address')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="aadhar_no" placeholder="Enter Aadhar Number" name="aadhar_no" type="text" value="{{ old('aadhar_no', $distributor['aadhar_no']) }}" />
                @error('aadhar_no')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="pan_no" placeholder="Enter PAN Number" name="pan_no" type="text" value="{{ old('pan_no', $distributor['pan_no']) }}" />
                @error('pan_no')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <div class="input-group">
                    ...
                    @if($distributor['pan_doc'])
                    <a href="{{ asset('/storage/'.$distributor['pan_doc']) }}" target="_blank" class="btn btn-dark" type="button"><i class="fa-solid fa-download"></i></a>
                    @endif
                </div>
                @error('pan_doc')
                <span class="invalid-feedback" role="alert">
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <div class="input-group">
                    ...
                    @if($distributor['bank_proof_doc'])
                    <a href="{{ asset('/storage/'.$distributor['bank_proof_doc']) }}" target="_blank" class="btn btn-dark" type="button"><i class="fa-solid fa-download"></i></a>
                    @endif
                </div>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="bank_name" placeholder="Enter Bank Name" name="bank_name" type="text" value="{{ old('bank_name', $distributor['bank_name']) }}" />
                @error('bank_name')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="bank_account_number" placeholder="Enter Account Number" name="bank_account_number" type="text" value="{{ old('bank_account_number', $distributor['bank_account_number']) }}" />
            ...
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <input class="form-control" id="bank_ifsc_code" placeholder="Enter IFSC Code" name="bank_ifsc_code" type="text" value="{{ old('bank_ifsc_code', $distributor['bank_ifsc_code']) }}" />
