        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon">
                    @if(userCan(105, 'can_view'))
                    <a href="{{ route('distributors.export', [ 'main_distributor' => request('main_distributor') ]) }}"
                    ...
                    @if(userCan(105, 'can_add'))
                    <a href="{{ route('distributors.add') }}" class="btn btn-outline-secondary me-4">
