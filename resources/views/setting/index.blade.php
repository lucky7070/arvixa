		...
		<div class="card mb-3">
			...
			<div class="card-body">
				<form class="form-sample" id="settingForm{{ $setting_id }}"
					...
					@csrf
					<fieldset @if(userCan(101, 'can_edit' )==false) disabled @endif>
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								...
								<input type="hidden" name="{{ 'old_'.$field['setting_name'] }}"
							...
							<div class="col-md-6 mb-3">
								...
								<div class="custom-switch py-2">
									<label class="switch">
										<input type="checkbox" name="{{ $field['setting_name'] }}" {{
											$field['filed_value']==1 ? 'checked="true"' : '' }}>
							...
							@endforeach
							<div class="col-md-12">
								@if(userCan(101, 'can_edit'))
								<button id="submit" type="submit"
									class="btn btn-primary me-2 btn-custom btn-custom-color">Submit</button>
								@endif
