...
<div class="container-xl">
    <div class="row my-5">
        ...
        <div class="col-md-6 py-lg-5 p-8 login-box p-5">
            ...
            <form method="POST" action="{{ route('retailer.register') }}" novalidate="novalidate">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-theme-info">Sign Up - <span class="text-secondary fw-bold">Retailer</span></h2>
                        <p>Enter your email and password to register</p>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="input-group">
                            <span class="fa fa-user"></span>
                            <input placeholder="Your Name" id="name" type="text" class="form-control " name="name"
