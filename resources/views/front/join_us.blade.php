...
<div class="container-fluid bg-light-theme text-center py-4 text-theme">
    <h2 class="mb-1 fw-bolder">Join Us</h2>
    <p class="mb-1">
        <a href="" class="text-decoration-none text-theme">Home</a> / Join Us
    </p>
</div>
                                        ...
                                        <div class="md-form mb-0">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select id="request_for" name="request_for"
                                                    ...
                                                    <option value="">Join Us As</option>

                                                    <option value="2" @select(old('request_for')==2)>

                                                        Main Distributor

                                                    </option>

                                                    <option value="3" @select(old('request_for')==3)>

                                                        Distributor

                                                    </option>

                                                    <option value="4" @select(old('request_for')==4)>
        ...
        $("#contact-form").validate({
            ...
            messages: {
                ...
                request_for: {
                    ...
                    required: "Please select join us as.",
