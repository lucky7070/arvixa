            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="table-responsive scrollbar">
                        <table id="zero-config" class="table custom-table mb-0 table-datatable" style="width:100%">
                    ...
                    <div class="card-body p-3 text-dark">
                        <div class="row">
                            <div
                                ...
                                <p class="lead text-theme fw-bold mb-0">Purchase Reciept</p>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="lead text-theme fw-bold mb-0 pb-2">Tracking Order</p>
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        data: { order_id, _token: $('meta[name="csrf-token"]').attr('content') },
                        type: 'POST',
