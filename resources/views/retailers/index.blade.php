        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon">
                    ...
                    <a href="{{ route('retailers.export', [ 'main_distributor' => request('main_distributor'), 'distributor' => request('distributor') ]) }}"
                    ...
                    @if(userCan(106, 'can_add'))
                    <a href="{{ route('retailers.add') }}" class="btn btn-outline-secondary me-2">
                        <i class="fa fa-plus me-1"></i>
                        Add Retailer
                    </a>
                    @endif

                    <a href="{{ route('retailers.not_loaded') }}" class="btn btn-outline-danger">
                        <i class="fa-duotone fa-users me-1"></i>
                        Who Not Loaded Balance
                    </a>
                </div>
            </div>
        </div>
