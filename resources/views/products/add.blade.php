...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Products :: Product Add </h5>
            </div>
    ...
    <div class="card-body">
        <form class="row" id="addProduct" method="POST" action="{{ route('products.add') }}"
            ...
            <div class="col-lg-4 mt-2">
                ...
                <textarea class="form-control" id="sort_description" placeholder="Enter Sort Description"
                    name="sort_description">{{ old('sort_description') }}</textarea>
            ...
            <div class="col-md-4 mt-2">
                ...
                <input class="form-control" type="number" id="weight" name="weight" value="{{ old('weight', 100) }}"
                    placeholder="Weight" />
                @error('weight')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
            ...
            <div class="col-md-8 mt-2">
                ...
                <div class="input-group">
                    <input class="form-control" type="number" name="length" id="length" value="{{ old('length', 10) }}"
                        placeholder="Length" />
                    <input class="form-control" type="number" name="width" id="width" value="{{ old('width', 10) }}"
                        placeholder="Width" />
                    <input class="form-control" type="number" name="height" id="height" value="{{ old('height', 10) }}"
                        placeholder="Height" />
                </div>
                @error('length')
                <span class="invalid-feedback" role="alert">
            ...
            <div class="col-md-4 mt-2">
                ...
                <select name="hsn_code_id" class="form-select js-choice" id="hsn_code_id" required="required">
                    ...
                    <option value="{{ $hsn_code['id'] }}" @selected(old('hsn_code_id')==$hsn_code['id'])>
                        {{ $hsn_code['code'] }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-4 mt-2">
                ...
                <select name="is_feature" class="form-select" id="is_feature">
                    <option value="0" @selected(old('is_feature', 0)==0)> No </option>
                    <option value="1" @selected(old('is_feature', 1)==1)> Yes </option>
                </select>
                @error('is_feature')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
