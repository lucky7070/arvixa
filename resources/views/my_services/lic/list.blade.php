...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="mb-0">LIC Premium List</h5>
            <div>
                <a href="{{ route('retailer.lic-bill-export') }}" class="btn btn-success me-1">
                    <i class="fa fa-file-excel me-1"></i>
                    Export
                </a>
                <a href="{{ route('retailer.lic-bill') }}" class="btn btn-primary me-1">
