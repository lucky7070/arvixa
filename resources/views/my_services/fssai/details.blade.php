        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="">{{ $data->district_center }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Status</span>
                        @switch($data->status)
            ...
            <div class="col-md-6 mb-3">
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>PanCard Has </span>
                        <span class="">{{ yesNo($data->pancard_has) }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-6 mb-3">
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Building </span>
                        <span class="">{{ $data->building_plant }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-6 mb-3">
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Flat </span>
                        <span class="">{{ $data->official_flat }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Building </span>
                        <span class="">{{ $data->official_building }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Block /Street </span>
                        <span class="">{{ $data->official_block }}, {{ $data->official_street }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Village </span>
                        <span class="">{{ $data->official_village }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>City</span>
                        <span class="">{{ $data->official_city }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>State</span>
                        <span class="">{{ $data->official_state }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Country</span>
                        <span class="">{{ $data->official_country }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>PinCode</span>
                        <span class="">{{ $data->official_pincode }}</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <ul class="list-group mb-2">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>UAM Registered </span>
                        <span class="">{{ $data->uam_register }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>UAM Number </span>
                        <span class="">{{ $data->uam_number }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Unit Started </span>
                        <span class="">{{ yesNo($data->enterprise_production) }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-6 mb-3">
                <ul class="list-group">
                    <li class="list-group-item active">
                        <h6 class="mb-0 text-white fw-bold">Investment Details</h6>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Depreciated Cost as of the Previous Year </span>
                        <span class="">₹ {{ $data->inv_wdv_a }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Cost of Research & Development </span>
                        <span class="">₹ {{ $data->inv_wdv_b }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Net Investment in Plant </span>
                        <span class="">₹ {{ $data->inv_wdv_total }}</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <ul class="list-group">
                    <li class="list-group-item active">
                        <h6 class="mb-0 text-white fw-bold">Turnover Details</h6>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="">₹ {{ $data->turnover_b }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Net Turnover </span>
                        <span class="">₹ {{ $data->turnover_total }}</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <ul class="list-group">
                    <li class="list-group-item active">
                        <h6 class="mb-0 text-white fw-bold">Other Details</h6>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Registered on Government e-Market (GeM) Portal </span>
                        <span class="">{{ yesNo($data->get_register) }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>Registered on TReDS Portals </span>
                        <span class="">{{ yesNo($data->get_register) }}</span>
                    </li>
                </ul>
            </div>
