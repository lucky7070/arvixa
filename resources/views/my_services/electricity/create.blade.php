...
<div class="row">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('retailer.electricity-bill-list') }}" class="btn btn-primary me-1">
    ...
    <div class="col-12" id="bill-details" style="display: none;">
        <div class="card">
            ...
            <div class="card-body">
                <form id="submit-form" action="{{ route('retailer.electricity-payment-submit') }}" method="post">
                    <div class="row mb-3">
...
<script>
    $(function() {
        ...
        const validator = $("#electricity-fetch-form").validate({
            debug: false,
