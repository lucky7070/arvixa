...
<div class="card mb-3">
        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <a href="{{ route('main_distributor.retailers')  }}" class="btn btn-outline-secondary me-4"> <i
    ...
    <div class="card-body">
        <form class="row" id="ediUser" method="POST"
            action="{{ route('main_distributor.retailers.edit', $retailer['id']) }}" enctype='multipart/form-data'>
            @csrf
            <div class="col-lg-4 col-md-6 mt-2">
                ...
                <select name="distributor_id" class="form-select" id="distributor_id">
                    @foreach ($distributors as $main_distributor)
                    <option value="{{ $main_distributor['id'] }}" {{ old('distributor_id',
                        $retailer['distributor_id'])==$main_distributor['id'] ? 'selected' : '' }}>
