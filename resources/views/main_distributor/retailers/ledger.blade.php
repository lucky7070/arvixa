        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon">
                    <a href="{{ route('main_distributor.retailers')  }}" class="btn btn-outline-secondary me-2">
...
<script type="text/javascript">
    $(function () {
        var table = $('.table-datatable').DataTable({
            ajax: "{{ route('main_distributor.retailers.ledger', $user['slug']) }}",
            order: [
                [1, 'desc']
            ],
            columns: [{
        ...
        $("#addForm").validate({
            ...
            submitHandler: function (form) {
                ...
                $("#overlay").show();
                $.ajax({
                    url: "{{ route('main_distributor.retailers.ledger', $user['slug']) }}",
                    data: formData,
                    contentType: false,
                    processData: false,
                    type: 'POST',
