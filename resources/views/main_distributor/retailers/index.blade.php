        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon">
                    <a href="{{ route('main_distributor.retailers.add') }}" class="btn btn-outline-secondary me-4"> <i
...
<script type="text/javascript">
    $(function () {
        var table = $('.table-datatable').DataTable({
            ajax: "{{ route('main_distributor.retailers') }}",
            order: [
                [4, 'desc']
            ],
            columns: [{
        ...
        $(document).on('click', ".delete", function () {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "{{ route('main_distributor.retailers.delete') }}",
                        data: { 'id': id },
                        type: 'DELETE',
