    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">Distributors :: Services -
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <a href="{{ route('main_distributor.distributors')  }}" class="btn btn-outline-secondary me-4"> <i
                    ...
                    <tr class="">
                        <!-- <th class="checkbox-area" scope="col">
                            <div class="switch form-switch-custom form-switch-primary">
                                <input class="switch-input" data-service-id="on" type="checkbox" role="switch" />
                            </div>
                        </th> -->
...
<script type="text/javascript">
    $(document).on('change', '.switch-input', function () {
        ...
        var selector = this;
        $.ajax({
            url: "{{ route('main_distributor.distributors.services', [ 'slug' => $distributor['slug'] ]) }}",
            data: { service_id },
            type: 'POST',
