...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">Faq :: Faq Edit </h5>
            </div>
    ...
    <div class="card-body">
        <form class="row" id="ediUser" method="POST" action="{{ route('faq.edit', $faq['id']) }}"
            ...
            <div class="col-12 mt-2">
                ...
                <textarea placeholder="Add Your Question" name="question" id="question" cols="30" rows="3"
                    class="form-control">{{ old('question', $faq['question']) }}</textarea>
