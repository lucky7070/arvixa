        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon">
                    <a href="{{ route('employee.main_distributors.export') }}" class="btn btn-outline-success me-2">
                        <i class="fa fa-file-excel me-1"></i>
                        Export
                    </a>
                    <a href="{{ route('employee.main_distributors.add') }}" class="btn btn-outline-secondary">
...
<script type="text/javascript">
    $(function () {
        var table = $('.table-datatable').DataTable({
            ajax: "{{ route('employee.main_distributors') }}",
            order: [
                [5, 'desc']
            ],
            columns: [{
