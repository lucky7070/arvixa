...
<div class="card">
    <div class="card-body p-4 p-sm-5 text-center">
        ...
        <form class="mt-4 row g-0" action="{{ route('password.confirm') }}">
            @csrf
            <div class="col">
                <input placeholder="Enter your password" aria-label="User's password" aria-describedby="user-password" id="password" type="password" class="form-control me-2 mb-2 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                @error('password')
