...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">Customers :: Customer Edit </h5>
            </div>
    ...
    <div class="card-body">
        <form class="row" id="edit" method="POST" action="{{ route('customers.edit', $customer['id']) }}"
            ...
            <div class="col-lg-4 mt-2">
                ...
                <input class="form-control" id="middle_name" placeholder="Enter Middle Name" name="middle_name"
                    type="text" value="{{ old('middle_name', $customer['middle_name']) }}" />
                @error('middle_name')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-lg-6 mt-2">
                ...
                <select class="form-control" id="gender" name="gender">
                    ...
                    <option value="{{ $key }}" {{ old('gender', $customer['gender'])==$key ? 'selected' : '' }}>{{
                        $gender }}</option>
                    @endforeach
                </select>
            ...
            <div class="col-lg-6 mt-2">
                ...
                <select name="state_id" onchange="getCity(this.value)" class="form-select" id="state_id">
                    ...
                    <option value="{{ $state['id'] }}" {{ old('state_id', $customer['state_id'])==$state['id']
                        ? 'selected' : '' }}>
                        {{ $state['name'] }}
                    </option>
                    @endforeach
...
<script type="text/javascript">
    ...
    var city_id = "{{ old('city_id', $customer['city_id']) }}";
    ...
    $(window).on('load', function () {
        getCity("{{ old('state_id', $customer['state_id']) }}");
    })
