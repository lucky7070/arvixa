...
<div class="card mb-3">
        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto ms-auto">
                <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <a href="{{ route('users')  }}" class="btn btn-outline-secondary me-4"> <i
    ...
    <div class="card-body">
        <form class="row" id="ediUser" method="POST" action="{{ route('users.edit', $user['id']) }}"
            ...
            <div class="col-lg-6 mt-2">
                ...
                <select name="role_id" class="form-select" id="role_id">
                    ...
                    <option name="role_id" value="{{ $role['id'] }}" {{ (old('role_id')==$role['id'] ||
