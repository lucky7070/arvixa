...
class ElectricityController extends Controller
{
   ...
   public function index()
    {
        // Fetch all electricity bills with their related retailer and board
        $bills = ElectricityBill::with(['retailer', 'board'])
            ->where('bill_type', 'electricity')
            ->get(); // Note: NO pagination for DataTables JS
    
        return view('reports.electricity-bill.index', compact('bills'));
    }
    ...
    public function waterbill()
    {
        ...
        $bills = ElectricityBill::with(['retailer', 'board'])
                ->where('bill_type', 'water') // ✅ Only electricity bills
                 ->get();
     ...
     public function gasbill()
    {
        ...
        $bills = ElectricityBill::with(['retailer', 'board'])
                ->where('bill_type', 'gas') // ✅ Only electricity bills
                 ->get();
        return view('reports.gas-bill.index', compact('bills'));
    }
    
     public function licbill()
    {
        
        $bills = ElectricityBill::with(['retailer', 'board'])
                ->where('bill_type', 'lic') // ✅ Only electricity bills
                 ->get();
        return view('reports.lic-bill.index', compact('bills'));
    }
