...
class LicController extends Controller
{
    ...
    if (!$commission) {
        return redirect()->back()->with('error', 'lic service is not active for your account.');
    }
    ...
    return view('retailer.lic-bill', compact('bills'));
        
    }
    
    
    public function licGetDetails(Request $request) {
        $url = 'https://www.mplan.in/api/lic.php';
    ...
    // public function licPaymentSubmit(Request $request)
    // {
    ...
    //     try {
    //         $licBill = new ElectricityBill();
    //         $licBill->transaction_id = $transactionId;
    //         $licBill->user_id        = $retailer->id;
    //         $licBill->board_id       = $request->board_id;
    //         $licBill->consumer_no    = $request->consumer_no;
    //         $licBill->consumer_name  = $request->consumer_name;
    //         $licBill->bill_no        = $request->bill_no;
    //         $licBill->bill_amount    = $amountDue;
    //         $licBill->bill_type    = 'lic';
    //         $licBill->due_date       = \Carbon\Carbon::createFromFormat('d-m-Y', trim($request->due_date))->format('Y-m-d');            
    //         $licBill->save();
      ...
      public function licPaymentSubmit(Request $request)
        {
            ...
            try {
                ...
                $electricityBill->bill_type    = 'electricity';
                ...
                $paymentTransaction->particulars = "Lic bill paid for Consumer No.: " . $request->consumer_no;
                ...
                if ($commission) {
                    ...
                    $commissionTransaction->particulars = "Lic Bill Service Commission credited for Consumer No.: " . $request->consumer_no;
